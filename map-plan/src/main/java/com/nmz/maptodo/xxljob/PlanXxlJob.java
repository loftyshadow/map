...
import static com.nmz.maptodo.exception.PlanException.PLAN_NOT_EXIST_EXCEPTION;
...
public class PlanXxlJob {
     ...
     * 1、简单任务示例（Bean模式）
     */
    @XxlJob("planJobHandler")
    public void planJobHandler() throws Exception {
        ...
        XxlJobHelper.log("XXL-JOB, 执行plan模块定时任务完成.");
        logger.info("XXL-JOB, 执行plan模块定时任务完成.");
    }
