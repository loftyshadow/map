...
@ToString
@Embeddable
public class PlanRecordDetailId implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        PlanRecordDetailId entity = (PlanRecordDetailId) o;
    ...
    public PlanRecordDetailId() {
    }

    public PlanRecordDetailId(Long recordId) {
        this.recordId = recordId;
    }

    public PlanRecordDetailId(Long recordId, Long recordDetailId) {
        this.recordId = recordId;
